...
In the case of tests running in openstack-ci, nodepool provides a virtual machine to the beaker test. Beaker then ssh's into localhost and performs configuration and testing.
