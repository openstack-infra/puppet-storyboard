...
#
class storyboard::cert (
  $ssl_cert_file    = '/etc/ssl/certs/storyboard.pem',
  $ssl_cert_content = undef,

  $ssl_key_file     = '/etc/ssl/private/storyboard.key',
  $ssl_key_content  = undef,

  $ssl_ca_file      = undef, # '/etc/ssl/certs/ca.pem'
  ...
  if ($ssl_ca_file != undef or $ssl_ca_content != undef) \
      and $ssl_ca_file == undef {
    $resolved_ssl_ca = '/etc/ssl/certs/storyboard.ca.pem'
  } else {
    $resolved_ssl_ca = $ssl_ca_file
  }
